package edu.fsu.equidistant.location
...
class LocationService : Service() {
    ...
    private fun generateNotification(location:Location?): Notification {
        ...
        val titleText = getString(edu.fsu.equidistant.R.string.app_name)
        ...
        return notificationCompatBuilder
            ...
            .addAction(edu.fsu.equidistant.R.drawable.ic_home,"Launch Activity",activityPendingIntent)
            .addAction(edu.fsu.equidistant.R.drawable.ic_home,"Stop Location Updates",servicePendingIntent)
            .build()
    }
